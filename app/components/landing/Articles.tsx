      ...
      <div>
        ...
        <div className="hidden md:block">
          <Slider ref={sliderRef} {...settings}>
            {initialItems.map((item) => <Article key={item.id} img={item.img} title={item.title} desc={item.desc} date={item.date} auther={item.auther} autherImg={item.autherImg} />)}
          </Slider>
        </div>
        ...
        <div className="mt-3 md:mt-14 w-full flex justify-center relative mb-3 max-w-[1216px] mx-auto md:py-3">
          {/* Show More Button */}
          <Link className="inline-block text-sm text-gray-700 text-center py-[9px] px-5 border border-gray2-300 rounded-lg bg-white w-full md:w-auto" href={"/articles"}>{button}</Link>
          {/* Slider Button */}
