...
const FAQs = () => {
  return (
    <section className="px-4 mt-12 md:mt-24">
      {/* Section Title */}
      <h2 className="font-yekanBakhNumbExtraBold text-balck text-[32px] md:text-[40px] text-center mb-8">سوالات متداول</h2>
      
      {/* FAQs */}
      <div className="flex flex-col gap-3">
        {items.map((item) => <FAQ key={item.id} question={item.question} answer={item.answer} open={true} />)}
      </div>
