...
const faItems = [
  ...
  {id: "faq7", question: "آیا امکان ورود و یا خروج اطلاعات بوسیله فایل اکسل وجود دارد؟", answer: "در بخش های اصلی و مهم سیستم مثل تعریف کالا ، طرف حساب ، فاکتورها ، رسید ها ، نقل و انتقال چک ها ، اسناد حسابداری و ... این امکان برای کاربران فراهم شده است ."},
]
