...
const LoginToApp = () => {
  ...
  return (
    <section className="max-w-[1216px] mx-auto w-full mt-14 md:mt-20 px-4">
      <section className="bg-gray2-25 rounded-3xl flex flex-col md:flex-row justify-between gap-6 items-center w-full px-3 py-16 md:p-16">
        ...
        <Link href={`/${language}/register`} className="text-white text-center bg-brand-600 rounded-lg py-[10px] md:py-3 px-6 inline-block w-full md:w-auto">{t("button")}</Link>
      </section>
    </section>
  );
};
