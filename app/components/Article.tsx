...
const Article: React.FC<ArticleProps> = ({ img, auther, autherImg, title, desc, date }) => {
  return (
    <article className="bg-gray2-50 rounded-3xl overflow-hidden mx-1 md:mx-4 dir-right p-3 md:p-0">
      ...
      <div className="mt-5 md:mt-0 md:p-4">
